import{o as e}from"./preload-helper-BKhVKv2_.js";import{t}from"./iframe-B_Bti3oz.js";import{_t as n,t as r,vt as i}from"./components-CXdGP71K.js";import{i as a,n as o,r as s,t as c}from"./DataDecorator-4OOucIRl.js";var l,u,d,f,p,m,h,g,_,v,y,b,x;e((()=>{r(),a(),l=t(),{fn:g}=__STORYBOOK_MODULE_TEST__,_={component:n,title:`Data/Data Table`,argTypes:{onSelectionChange:{table:{disable:!0}},isSelectable:{name:`Selectable (onSelectionChange)`,control:`boolean`,description:`Toggle to enable selection checkboxes`},clickToLoad:{control:`boolean`,description:`Require a click to load data (when using loader)`}},args:{onHeaderClick:g(),onSelectionChange:g(),isSelectable:!0,clickToLoad:!1}},v={argTypes:{clickToLoad:{table:{disable:!0}}},render:e=>{let{isSelectable:t,onSelectionChange:r,clickToLoad:i,...a}=e,o=t?r:void 0;return(0,l.jsx)(c,{children:e=>(0,l.jsx)(n,{...e,...a,onSelectionChange:o,columns:s})})}},y={render:e=>{let{isSelectable:t,onSelectionChange:n,...r}=e,a=t?n:void 0;return(0,l.jsx)(o,{children:e=>(0,l.jsx)(i,{...e,...r,onSelectionChange:a,columns:s})})}},b={render:e=>{let{isSelectable:t,onSelectionChange:n,...r}=e,a=t?n:void 0;return(0,l.jsx)(o,{children:e=>(0,l.jsx)(i,{...e,...r,onSelectionChange:a,loading:!0,columns:[...s,{label:`Column 6`,name:`content6`,render:e=>e.content6.complexValue}]})})}},v.parameters={...v.parameters,docs:{...(u=v.parameters)==null?void 0:u.docs,source:{originalSource:`{
  argTypes: {
    clickToLoad: {
      table: {
        disable: true
